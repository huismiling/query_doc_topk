...
{    
    ...
    // doc_query_scoring_gpu_function(inputs.querys, 1, inputs.docs, inputs.doc_lens, indices);
    indices.clear();
    ...
    doc_query_scoring_gpu_function(inputs.querys, n_querys, inputs.docs, inputs.doc_lens, indices);
    
    std::chrono::high_resolution_clock::time_point t3 = std::chrono::high_resolution_clock::now();
    std::cout<< "n_querys " << n_querys << " topk cost " << std::chrono::duration_cast<std::chrono::milliseconds>(t3 - t2).count() << " ms " << std::endl;
